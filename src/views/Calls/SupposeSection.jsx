...
const SuposeSection = (props) => {
  ...
  return (
    <div className=" p-5 md:mt-5   bg-slate-100 dark:bg-gray-900 relative">
      <h3 className="text-xl pb-5 text-center font-bold dark:text-white">Suppose Information</h3>
      <div className="grid grid-cols-4  gap-4 ">
        ...
        <div className="intro-x ">
          ...
          <input type="text" className="form-control" name="gpa" />
        </div>
